...
function getStatusLabel(t) {
  return {
    ...
    RELEASING:        t('status_airing'),
    NOT_YET_RELEASED: t('disc_status_not_yet_released'),
    CANCELLED:        t('disc_status_cancelled'),
  };
}
...
function EpisodePip({ series }) {
  ...
  return (
    <span className="flex items-center gap-0.5 text-orange-300 text-xs">
      <AlertCircle size={10} /> {t('anim_missing_prefix')} {missing}
    </span>
  );
}
