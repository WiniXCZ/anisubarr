...
# backend.log is at the Docker WORKDIR /app — three parents up from routers/logs.py
# (/app/app/routers/logs.py -> /app/app/routers -> /app/app -> /app)
LOG_PATH = Path(__file__).parent.parent.parent / "backend.log"
